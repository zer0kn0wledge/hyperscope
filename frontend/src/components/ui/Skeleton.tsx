// Note: The `skeleton-shimmer` keyframe animation is defined once in globals.css.
// It should NOT be duplicated here via inline <style> tags to avoid multiple
// identical @keyframes declarations being injected into the DOM on every render.
//
// Required entry in globals.css:
